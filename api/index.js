...
var INITIAL_ORDERS = [
  {
    ...
    items: [
      { menuItemId: "m1", name: "Truffle Parmesan Fries", price: 14, quantity: 1 },
      { menuItemId: "m5", name: "Pan-Seared Atlantic Salmon", price: 36, quantity: 1, notes: "Medium-well, dill sauce on side" },
      { menuItemId: "m9", name: "Smoked Maple Old Fashioned", price: 18, quantity: 2 }
    ],
    subtotal: 86,
    discount: 10,
    // 10% off
  ...
  },
  {
    ...
    items: [
      { menuItemId: "m2", name: "Heirloom Tomato Bruschetta", price: 16, quantity: 2 },
      { menuItemId: "m6", name: "Wild Mushroom Risotto", price: 28, quantity: 2 },
      { menuItemId: "m10", name: "Hibiscus Lime Mocktail", price: 9.5, quantity: 3 }
    ],
    subtotal: 116.5,
    discount: 0,
    tax: 8,
  ...
  },
  {
    ...
    items: [
      { menuItemId: "m3", name: "Crispy Calamari Fritti", price: 19.5, quantity: 1 },
      { menuItemId: "m4", name: "Prime Dry-Aged Ribeye", price: 49, quantity: 2, notes: "One medium rare, one medium" },
      { menuItemId: "m7", name: "Molten Chocolate Lava Cake", price: 15, quantity: 1 }
    ],
    subtotal: 132.5,
    discount: 5,
    tax: 8,
  ...
  },
  {
    ...
    items: [
      { menuItemId: "m1", name: "Truffle Parmesan Fries", price: 14, quantity: 2 },
      { menuItemId: "m6", name: "Wild Mushroom Risotto", price: 28, quantity: 1 }
    ],
    subtotal: 56,
    discount: 0,
    tax: 8,
    ...
    updatedAt: new Date(Date.now() - 60 * 60 * 1e3).toISOString(),
    waiterId: "s5",
    waiterName: "David Lee"
  },
  {
    ...
    items: [
      { menuItemId: "m11", name: "Gourmet Wagyu Truffle Burger", price: 42, quantity: 2 },
      { menuItemId: "m8", name: "Classic Espresso Tiramisu", price: 13.5, quantity: 2 }
    ],
    subtotal: 111,
    discount: 15,
    tax: 8,
    grandTotal: 101.89,
    status: "Served",
    createdAt: new Date(Date.now() - 65 * 60 * 1e3).toISOString(),
...
var INITIAL_RESERVATIONS = [
  ...
  },
  {
    ...
    status: "Pending",
    createdAt: new Date(Date.now() - 6 * 60 * 1e3).toISOString()
  },
  {
    id: "r4",
    ...
    status: "Confirmed",
    createdAt: new Date(Date.now() - 12 * 60 * 1e3).toISOString()
  },
  {
    id: "r5",
...
var INITIAL_INVENTORY = [
  { id: "i1", name: "A5 Wagyu Beef", category: "Meats", currentStock: 8.5, minimumStock: 5, unit: "kg", supplier: "Miyazaki Farms", expiryDate: "2026-07-05", unitCost: 150 },
  { id: "i2", name: "Maine Lobster Tail", category: "Seafood", currentStock: 3, minimumStock: 10, unit: "units", supplier: "Atlantic Harbors Ltd", expiryDate: "2026-06-30", unitCost: 18.5 },
  // Low stock!
  { id: "i3", name: "White Truffle Oil", category: "Oils & Condiments", currentStock: 1.2, minimumStock: 1.5, unit: "liters", supplier: "Alba Imports", expiryDate: "2027-02-14", unitCost: 95 },
  // Low stock!
  { id: "i4", name: "Arborio Rice", category: "Dry Goods", currentStock: 25, minimumStock: 10, unit: "kg", supplier: "Vercelli Grains", expiryDate: "2027-06-15", unitCost: 3.5 },
  { id: "i5", name: "Fresh Atlantic Salmon", category: "Seafood", currentStock: 12, minimumStock: 8, unit: "kg", supplier: "Nordic Blue Salmon", expiryDate: "2026-07-02", unitCost: 24 },
  { id: "i6", name: "Pecorino Romano", category: "Dairy", currentStock: 14.5, minimumStock: 6, unit: "kg", supplier: "Lazio Dairy Co", expiryDate: "2026-08-20", unitCost: 16 },
  { id: "i7", name: "Madagascar Vanilla Pods", category: "Spices", currentStock: 0.1, minimumStock: 0.2, unit: "kg", supplier: "Bourbon Spices", expiryDate: "2027-12-01", unitCost: 450 },
  // Low stock!
  { id: "i8", name: "Fresh Organic Mint", category: "Produce", currentStock: 4.2, minimumStock: 2, unit: "kg", supplier: "Green Valley Labs", expiryDate: "2026-07-01", unitCost: 8 }
];
var INITIAL_STAFF = [
  ...
  { id: "s14", name: "Amelia Du Pont", role: "Manager", contact: "+1 (555) 231-5544", shiftTiming: "04:00 PM - 11:00 PM", attendanceStatus: "Present", performanceRating: 5, image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80" }
];
var INITIAL_ACTIVITIES = [
  { id: "a1", type: "order", message: "New order DF-4002 created for Table 4.", time: new Date(Date.now() - 5 * 60 * 1e3).toISOString(), severity: "info" },
  { id: "a2", type: "order", message: "Order DF-4003 marked as READY for Table 8.", time: new Date(Date.now() - 10 * 60 * 1e3).toISOString(), severity: "success" },
  { id: "a3", type: "inventory", message: "Low stock warning: Maine Lobster Tail is below minimum threshold.", time: new Date(Date.now() - 120 * 60 * 1e3).toISOString(), severity: "warning" },
  { id: "a4", type: "reservation", message: "New online reservation confirmed for Eleanor Vance (2 guests) tomorrow.", time: new Date(Date.now() - 6 * 60 * 1e3).toISOString(), severity: "success" },
  { id: "a5", type: "table", message: "Table 5 changed status to Cleaning.", time: new Date(Date.now() - 15 * 60 * 1e3).toISOString(), severity: "info" },
  { id: "a6", type: "staff", message: "Sarah Jenkins checked in for the Evening shift.", time: new Date(Date.now() - 235 * 60 * 1e3).toISOString(), severity: "info" }
];
...
var INITIAL_FEEDBACK = [
  ...
  },
  {
    ...
    createdAt: new Date(Date.now() - 300 * 60 * 1e3).toISOString(),
    status: "Pending",
    category: "Service"
  },
  {
    ...
    createdAt: new Date(Date.now() - 480 * 60 * 1e3).toISOString(),
    status: "Approved",
